...
public class RomVersionDetailPreferenceController extends BasePreferenceController {
    ...
    private static final Uri INTENT_URI_DATA = Uri.parse("https://paypal.me/spkal01/");
    private static final String TAG = "romDialogCtrl";
    private static final String KEY_ROM_VERSION_PROP = "org.spark.build_version";
    private static final String KEY_ROM_RELEASETYPE_PROP = "org.spark.build_type";
    private static final String KEY_ROM_CODENAME_PROP = "org.spark.build_codename";
